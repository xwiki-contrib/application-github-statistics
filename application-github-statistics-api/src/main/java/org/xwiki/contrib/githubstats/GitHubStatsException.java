...
/**
 * A GitHubStats application error.
 *
 * @version $Id$
 * @since 5.3M2
 */
@Unstable
public class GitHubStatsException extends Exception
{
    /**
     ...
     */
    public GitHubStatsException(String message)
    {
        super(message);
    }
     ...
     */
    public GitHubStatsException(String message, Throwable throwable)
    {
